<?php $slug_url = isset($_GET['slug']) ? "notice/college/".$_GET['slug'] : '';  ?>
<?php include_once('settings.php');
include_once("connection.php");
include_once("function.php");

$records = [];
$fetchallqry = "SELECT id, notice_title, tags, description, slug, notice_type, url_link, page_link  FROM notice_colleges WHERE slug='".$slug_url."'";
