...
";
        ...
        if (!empty($masterSlugRecord['university_type_id'])) {
            $sql .= " AND universities.university_type_id = :university_type_id";
        }
        ...
        if (!empty($masterSlugRecord['university_type_id'])) {
            $stmt->bindParam(':university_type_id', $masterSlugRecord['university_type_id'], PDO::PARAM_INT);
        }
...
<section class="bg-light">
        <div class="container-fluid page_header">
            <div class="row">
                <div class="col-md-10">
                    <img class="rounded" src="images/kolkata-universities.png">
                    <a href="<?php echo BASE_URL;?>/kolkata-universities.php">
                    ...
                    <span class="subType1">
                        ...
                        <a href=""><?php echo ucwords(getStateNameById($masterSlugRecord['state_id'])); ?></a>, 
                        <?php } ?>
                        <?php if($masterSlugRecord['country_id']!=0 && $masterSlugRecord['country_id']!=NULL){ ?>
                        <a href=""><?php echo ucwords(getCountryNameById($masterSlugRecord['country_id'])); ?></a>
                        <?php } ?>
                    </span>
                    <?php } ?>
                    <span class="subType2">
