<section class="bg-light">
    <div class="container-fluid c_page_header">
        <div class="row">
            <div class="col-md-10">
                <img src="<?php echo $logoImgPath;?>" alt="<?php echo strtolower ($college_name);?> logo" title="<?php echo strtolower ($college_name);?> logo">
                ...
                <span class="college_affiliation">
                    <i class="fas fa-university"></i> <?php echo $university_name;?> (<?php echo $university_short_name;?>)
                </span>
            </div>
            <div class="col-md-2">
                <?php if(SHOW_C_PAGE_HEADER_ADM_LINK==1) {?>
                <a class="btn btn-danger w-100 p-2 pb-2 mt-4" href="<?php echo BASE_URL;?>/<?php echo $collegeSlug;?>/notice">
