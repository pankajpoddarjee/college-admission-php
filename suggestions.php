...
if (isset($_GET['search_query'])) {
   ...
   // $stmt_colleges->bindValue(':search_query', $search_query, PDO::PARAM_STR);
    ...
    //NOTICE COLLEGE
    $stmt_notices_college = $dbConn->prepare("SELECT notice_colleges.notice_title as name,notice_colleges.slug, notice_colleges.url_link ,'College Notice' as type, colleges.college_name As college_name , colleges.logo_img as college_logo_img FROM notice_colleges LEFT JOIN colleges ON notice_colleges.college_id = colleges.id WHERE (notice_colleges.notice_title LIKE :search_query OR notice_colleges.tags LIKE :tags) AND notice_colleges.is_active= :is_active");
