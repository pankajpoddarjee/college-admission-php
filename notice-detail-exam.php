<?php $slug_url = isset($_GET['slug']) ? "notice/exam/".$_GET['slug'] : '';  ?>
<?php include_once('settings.php');
include_once("connection.php");
include("function.php");
$records = [];
$fetchallqry = "SELECT id, notice_title, tags, description, slug, notice_type, url_link, page_link  FROM notice_exams WHERE slug='".$slug_url."'";
...
<title><?php echo $exam_name;?> - <?php echo $records['notice_title'];?> | <?php echo SITE_NAME;?></title>
<meta name="keywords" content="<?php echo strtolower($exam_name);?>, <?php echo strtolower($records['notice_title']);?>, <?php echo strtolower($records['tags']);?>">

<meta property="og:title" content="<?php echo $exam_name;?> - <?php echo $records['notice_title'];?> | <?php echo SITE_NAME;?>">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-9">
                	<div class="row">
                    	<div class="col-md-12">
                            <h5 class="alert alert-info" style="font-family:Archivo"><?php echo $records['notice_title'];?></h5>
                        </div>
                    </div>
