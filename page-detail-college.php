<?php $slug_url = isset($_GET['slug']) ? "pages/college/".$_GET['slug'] : '';  ?>
<?php include_once('settings.php');
include_once("connection.php");
//include("function.php");

$records = [];
$fetchallqry = "SELECT *  FROM page_colleges WHERE slug='".$slug_url."'";
...
<title><?php echo $record['college_name'];?> - <?php echo $records['page_title'];?> | <?php echo SITE_NAME;?></title>
<meta name="keywords" content="<?php echo strtolower($college_name);?>, <?php echo strtolower($records['page_title']);?>, <?php echo strtolower($records['tags']);?>">
<meta name="description" content="<?php echo $records['description'];?>">
<meta property="og:title" content="<?php echo $record['college_name'];?> - <?php echo $records['page_title'];?> | <?php echo SITE_NAME;?>">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-9">
                	<div class="row">
                    	<div class="col-md-12">
                            <h5 class="alert alert-info" title="<?php echo strtolower($college_name.' - '. $records['page_title']);?>" style="font-family:Archivo"><?php echo $records['page_title'];?></h5>
                        </div>
                    </div>
