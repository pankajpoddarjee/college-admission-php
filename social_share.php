...
<div class="social_buttons">
    ...
    //print_r($records);
    $shareTitle = "";
    if(isset($records['page_title'])){
        $shareTitle = ($records['page_title'])?$records['page_title']:'';
    }
    if(isset($records['notice_title'])){
