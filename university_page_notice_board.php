            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header alert-info text-uppercase">
                        <i class="fas fa-clipboard-list"></i> University  Notice Board <?php echo CURRENT_YEAR;?>
                    </div>
                    ...
                    <div class="card-footer bg-light text-right">
                        <a href="<?php echo BASE_URL;?>/<?php echo $universitySlug;?>/notice" title="Click here to view all updates." class="btn-link text-info" style="font-size:12px">
