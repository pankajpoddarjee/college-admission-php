...
if(count($universityRecord)>0){
    ...
    $fetchallqry = "SELECT * FROM notice_universities WHERE university_id=$university_id AND notice_year = $current_year AND is_active=1 order by notice_date desc, id desc" ;
    $stmt = $dbConn->prepare($fetchallqry);
    $stmt->execute();
        ...
        <div class="container-xxl">
            <div class="row">
                <div class="col-md-9">
                	...
                	<div class="row">
                    <?php 
                                $sql = "select distinct notice_year from notice_universities where university_id = $university_id AND is_active=1 order by notice_year desc";
