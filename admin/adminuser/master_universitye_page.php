...
$records = [];
$strsql="select * from page_universities  order by page_title";
$stmt = $dbConn->prepare($strsql);
$stmt->execute();
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify University Page | Admin - <?php echo COLLEGE_NAME; ?></title>
    ...
    <?php include("headermenu_left.php");?>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">University Page</span></h3>
                            </div>
                            ...
                            <table id="master-table" class="table table-bordered order-table" style="font-family:Rubik">
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-left"> <?php echo getUniversityNameById($row['university_id']); ?></td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">University Page</span>
                            </h4>
                            ...
                            <form id="frm1" name="frm1" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">                                       
                                        <button class="btn btn-danger btn-sm align-middle" id="save-university-page-button" name="submit">Save Data</button>
                                    </div>
        ...
        <script src="<?php echo BASE_URL_ADMIN;?>/adminuser/js/page_university.js"></script>
    </body>
</html>