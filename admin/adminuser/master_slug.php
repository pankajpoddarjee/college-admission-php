                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title Name" autocomplete="off" maxlength="150" onload="convertToSlug()" onkeyup="convertToSlug()">
                                        </div>
                                    </div>
