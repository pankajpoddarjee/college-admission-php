...
$records = [];
$strsql="select id,university_sub_type_name,is_active from university_sub_types  order by university_sub_type_name";
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify University Sub Type | Admin - <?php echo COLLEGE_NAME; ?></title>
    ...
    <?php include("headermenu_left.php");?>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">University Sub Type</span></h3>
                            </div>
                            ...
                            <table id="master-table" class="table table-bordered order-table" style="font-family:Rubik">
                                <thead class="bg-light text-center font-weight-bold">
                                    <tr>
                                        ...
                                        <td class="align-middle">University Sub Type Name</td>
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-left"> <?php echo $row['university_sub_type_name'];?></td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">University Sub Type</span>
                            </h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label for="university_sub_type_name">University Sub Type Name</label>
                                            <input type="text" class="form-control" id="university_sub_type_name" name="university_sub_type_name" placeholder="Enter University Sub Type Name" autocomplete="off" maxlength="75" tabindex="2">
                                        </div>
                                    </div>
        ...
        <script>
            ...
            function verifyInput() {
                if ($.trim($("#university_sub_type_name").val()) == "") {
                    toastr.error("Enter University Sub Type Name");
                    $("#university_sub_type_name").focus();
                    return false;
                }
                return true;
            }
            ...
            function saveData() {
                ...
                $.ajax({
                    type: "post",
                    async: false,
                    url: "Save_university_sub_type.php",
            ...
            $(".status-change").click(function() {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_university_sub_type.php?statusid=" + rid + "&status=" + status,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            alert(data.msg);
            ...
            $('#university_sub_type_name').on('keypress', function(event) {
            ...
            $(".get-record").click(function() {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_university_sub_type.php?eid=" + eid,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            $('#university_sub_type_name').val(data.record.university_sub_type_name);
