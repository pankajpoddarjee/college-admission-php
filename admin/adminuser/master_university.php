...
//GET ALL UNIVERSITY SUB TYPE
$universitySubTypeRecords = [];
$activeStatus = 1;
$strsql="select id,university_sub_type_name from university_sub_types where is_active = :is_active order by university_sub_type_name";
$stmt = $dbConn->prepare($strsql);
$stmt->bindParam(':is_active',$activeStatus);
$stmt->execute();
$universitySubTypeRecords = $stmt->fetchAll(PDO::FETCH_ASSOC);
//GET ALL COUNTRY
$countryRecords = [];
$activeStatus = 1;
...
//GET ALL UNIVERSITY
$records = [];
$strsql="select universities.*, cities.city_name, states.state_name, districts.district_name from universities JOIN districts ON universities.district_id = districts.id JOIN cities ON universities.city_id = cities.id JOIN states ON universities.state_id = states.id  order by university_name";
$stmt = $dbConn->prepare($strsql);
$stmt->execute();
                            ...
                            <table id="master-table" class="table table-bordered order-table" style="font-family:Rubik">
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-left"><?php echo $row['university_name'];  echo (!empty($row['short_name']))?' ['.$row['short_name'].']':'';  ?></td>                                        
                                        ...
                                        <a class="btn btn-info btn-sm" href="<?php echo BASE_URL.'/'.$row['slug']; ?>" target="_blank" title="<?php echo $row['university_name'];?>"><i class="fa fa-external-link" aria-hidden="true"></i>
                                        </a>
                                            <?php if($row['is_active'] == 1){ ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="university_name" name="university_name" placeholder="Enter University Name" autocomplete="off" maxlength="200" onload="convertToSlug();" onkeyup="convertToSlug();" onblur="convertToTags();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="other_name" name="other_name" placeholder="Enter Other Name" autocomplete="off" maxlength="250" onblur="convertToTags();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="university_sub_type_id">University Sub Type</label>                                            
                                            <select id="university_sub_type_id"  multiple="multiple" name="university_sub_type_id[]" class="form-control" onchange="convertToTags();">
                                                <option value="0" selected>Select</option>
                                                <?php if($universitySubTypeRecords){ 
                                                    foreach ($universitySubTypeRecords as $value) { 
                                                ?>
                                                <option value="<?php echo $value['id'] ?>"><?php echo $value['university_sub_type_name'] ?></option>
                                                <?php }} ?>
                                            </select>
                                        </div>
                                    </div>
