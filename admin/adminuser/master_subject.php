...
$records = [];
$strsql="select id,subject_name,is_active from subjects order by subject_name";
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify Subject | Admin - <?php echo COLLEGE_NAME; ?></title>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">Subject</span></h3>
                            </div>
                            ...
                            <table id="master-table" class="table table-bordered order-table" style="font-family:Rubik">
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-left"> <?php echo $row['subject_name'];?></td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">Subject</span>
                            </h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="subject_name" name="subject_name" placeholder="Enter Subject Name" autocomplete="off" maxlength="75" tabindex="2">
                                        </div>
                                    </div>
        ...
        <script>
            ...
            function verifyInput() {
                if ($.trim($("#subject_name").val()) == "") {
                    toastr.error("Enter Subject Name");
                    $("#subject_name").focus();
                    return false;
                }
                return true;
            ...
            $(".status-change").click(function() {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_subject.php?statusid=" + rid + "&status=" + status,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            alert(data.msg);
            ...
            $('#subject_name').on('keypress', function(event) {
            ...
            $('body').on('click', '.get-record', function (event) {
                ...
                $.ajax({
                    type: "get",
                    //async: false,
                    url: "Save_subject.php?eid=" + eid,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            $('#subject_name').val(data.record.subject_name);
