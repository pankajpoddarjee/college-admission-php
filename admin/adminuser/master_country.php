...
$records = [];
$strsql="select id,country_name,short_name,is_active from countries  order by country_name";
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify Country | Admin - <?php echo COLLEGE_NAME; ?></title>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">Country</span></h3>
                            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">Country</span>
                            </h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="country_name" name="country_name" placeholder="Enter Country Name" autocomplete="off" maxlength="75" tabindex="2">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
        ...
        <script>
            ...
            $(".status-change").click(function() {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_country.php?statusid=" + rid + "&status=" + status,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            alert(data.msg);
            ...
            $('#country_name').on('keypress', function(event) {
