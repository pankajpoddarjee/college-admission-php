...
$records = [];
$strsql="select districts.id,districts.district_name,districts.is_active, states.state_name, countries.country_name from districts JOIN countries on countries.id=districts.country_id JOIN states on states.id=districts.state_id order by countries.country_name, states.state_name, districts.district_name";
$stmt = $dbConn->prepare($strsql);
$stmt->execute();
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify District | Admin - <?php echo COLLEGE_NAME; ?></title>        
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">District</span></h3>
                            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">District</span>
                            </h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select id="country_id" name="country_id" class="form-control" onChange="getState(this.value);">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="district_name" name="district_name" placeholder="Enter District Name" autocomplete="off" maxlength="75">
                                        </div>
                                    </div>
        ...
        <script>
            ...
            $(".status-change").click(function() {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_district.php?statusid=" + rid + "&status=" + status,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            alert(data.msg);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 1) {
                            ...
                            $('#district_name').val(data.record.district_name);
            ...
            //Input Validation
            $('#district_name').on('keypress', function(event) {
			...
			function getState(cid) {
				...
				$.ajax({
                    type: "get",
                    async: false,
                    url: "Save_district.php?getState=" + cid,
                    dataType: "json",
                    success: function(data) {
                        $('#dvLoading').hide();	
                        if (data.status == 1) {
