...
//echo "<pre>"; print_r($collegeRecords);
...
//GET ALL NOTICE
$records = [];
$strsql="select * from notice_colleges order by notice_date desc, id desc";
$stmt = $dbConn->prepare($strsql);
$stmt->execute();
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify College Notices | Admin - <?php echo COLLEGE_NAME; ?></title>
    ...
    <?php include("headermenu_left.php");?>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">College Notice</span></h3>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="master-table" class="table table-bordered" style="font-family:Rubik">
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <?php if($row['has_attachment'] == 1){ ?>
                                            <a cname="<?php echo $name; ?>" cid="<?php echo $row['college_id']; ?>" nid="<?php echo $row['id']; ?>" class="btn btn-danger btn-sm get-attachment-record" href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="Upload Attachment"><i class="fa-solid fa-file-arrow-up"></i>
                                            </a>
                                         <?php } ?>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">College Notice</span>
                            </h4>
                        ...
                        <div class="modal-body">
                            <form id="frm1" name="frm1" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3" id="college_id_div">
                                        <div class="form-group">
            ...
            <div class="modal fade" id="add_edit_attachment_form" tabindex="-1" role="dialog" aria-labelledby="add_edit_formTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-file-arrow-up"></i> Upload <span class="text-danger">Attachment</span> [<span class="text-primary" id="college_name"></span>]
                            </h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        ...
                        <div class="modal-body">
                            <form id="frm2" name="frm2" method="post"  enctype="multipart/form-data">                                
                                ...
                                <input type="hidden" name="attch_college_id" id="attch_college_id">
                                ...
                                <input type="hidden" id="base_directory" name="base_directory" value="">
                                    ...
                                    <!-- <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="attch_college_id">College</label>                                            
                                            <select id="attch_college_id" name="attch_college_id" class="form-control" readonly>
                                                <option value="">Select</option>
                                                <?php if($collegeRecords){ 
                                                    foreach ($collegeRecords as $value) { 
                                                ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="year_directory">College Year Directory</label>                                            
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered table-sm order-table">
                                            <tbody id="attachments_file_list"></tbody>
                                        </table>
        ...
        <script src="<?php echo BASE_URL_ADMIN;?>/adminuser/js/notice_college.js"></script>
    </body>
</html>