...
$records = [];
$strsql="select id,exam_type_name,short_name,is_active from exam_types  order by exam_type_name";
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify Exam Type | Admin - <?php echo COLLEGE_NAME; ?></title>
    ...
    <?php include("headermenu_left.php");?>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">Exam Type</span></h3>
                            </div>
                            ...
                            <table id="master-table" class="table table-bordered order-table" style="font-family:Rubik">
                                <thead class="bg-light text-center font-weight-bold">
                                    <tr>
                                        ...
                                        <td class="align-middle">Exam Type</td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">Exam Type</span>
                            </h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exam_type_name" name="exam_type_name" placeholder="Enter Exam Type Name" autocomplete="off" maxlength="75" tabindex="2">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
        ...
        <script>
            ...
            function verifyInput() {
                if ($.trim($("#exam_type_name").val()) == "") {
                    toastr.error("Enter Exam Type Name");
                    $("#exam_type_name").focus();
                    return false;
                } 
            ...
            $(".status-change").click(function() {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_exam_type.php?statusid=" + rid + "&status=" + status,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            alert(data.msg);
            ...
            $('#exam_type_name,#short_name').on('keypress', function(event) {
            ...
            $('body').on('click', '.get-record', function (event) {
                ...
                $.ajax({
                    type: "get",
                    //async: false,
                    url: "Save_exam_type.php?eid=" + eid,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
