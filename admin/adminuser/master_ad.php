...
<html lang="en">
    ...
    <?php include("headermenu_left.php");?>
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-left">
                                            <a href="<?php echo BASE_URL_UPLOADS.'/ad/'.$row['ad_image'];?>" target="_blank">
                                                <img src="<?php echo BASE_URL_UPLOADS.'/ad/'.$row['ad_image'];?>" alt="" width="100" height="50">
                                            </a>
                                        </td>
                                        <td class="align-middle text-center"><?php echo $row['id'];?></td>
                                        <td class="align-middle text-left text-capitalize"><?php echo $row['ad_for'];?></td>
                                        <td class="align-middle text-left text-capitalize"><?php echo $row['position'];?></td>
                                        <td class="align-middle text-center"><a class="btn btn-sm btn-info" href="<?php echo $row['ad_link'];?>" target="_blank"><i class="fa-solid fa-up-right-from-square"></i></a></td>
                                        <td class="align-middle text-left"><?php echo $row['company_name'];?></td>
                                        <td class="align-middle text-center">
                                            <span class="text-success"><?php echo date('d-M-Y',strtotime($row['from_date']));?></span><br>
                                            <span class="text-danger"><?php echo date('d-M-Y',strtotime($row['to_date']));?></span>
                                        </td>
                        ...
                        <div class="modal-body">
                            <form id="frm1" name="frm1" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="ad_link">Ad For</label>
                                           

                                            <select name="ad_for" id="ad_for" class="form-control">
                                            <option value="">Select</option>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="ad_link">Position</label>
        ...
        function verifyInput() {
            ...
            if ($.trim($("#ad_for").val()) == "") {
                toastr.error("Selecet Ad For");
                $("#ad_for").focus();
                return false;
            }

            if ($.trim($("#position").val()) == "") {
                toastr.error("Selecet Position");
                $("#position").focus();
                return false;
            }
