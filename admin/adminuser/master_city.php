...
$records = [];
$strsql="select cities.id,cities.city_name,cities.is_active, states.state_name, countries.country_name from cities JOIN countries on countries.id=cities.country_id JOIN states on states.id=cities.state_id order by countries.country_name, states.state_name, cities.city_name";
$stmt = $dbConn->prepare($strsql);
$stmt->execute();
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify City | Admin - <?php echo COLLEGE_NAME; ?></title>        
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">City</span></h3>
                            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">City</span>
                            </h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="city_name" name="city_name" placeholder="Enter City Name" autocomplete="off" maxlength="75">
                                        </div>
                                    </div>
        ...
        <script>
            ...
            $(".status-change").click(function() {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_city.php?statusid=" + rid + "&status=" + status,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            alert(data.msg);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 1) {
                            ...
                            $('#city_name').val(data.record.city_name);
            ...
            //Input Validation
            $('#city_name').on('keypress', function(event) {
			...
			function getState(cid) {
				...
				$.ajax({
                    type: "get",
                    async: false,
                    url: "Save_city.php?getState=" + cid,
                    dataType: "json",
                    success: function(data) {
                        $('#dvLoading').hide();	
                        if (data.status == 1) {
