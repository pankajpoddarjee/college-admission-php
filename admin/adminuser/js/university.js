            ...
            function tags_with_space(){
                ...
                var university_sub_type_name = $('#university_sub_type_id option:selected').text().trim();
                if(university_sub_type_name && university_sub_type_name!='Select' && university_sub_type_name!='select'){
                    university_sub_type_name = university_sub_type_name.toLowerCase();
                    $('#tags').tagsinput('add', university_sub_type_name);
                }
            ...
            function tags_with_hyphen(){
                ...
                var university_sub_type_name = $('#university_sub_type_id option:selected').text().trim();
                if(university_sub_type_name && university_sub_type_name!='Select' && university_sub_type_name!='select'){
                    university_sub_type_name = university_sub_type_name.replace(/[`~!@#$%^&*()_\-+=\[\]{};:'"\\|\/,.<>?\s]/g, ' ')
                        .toLowerCase();
                    university_sub_type_name = university_sub_type_name.replace(/^\s+|\s+$/gm,'');

                    university_sub_type_name = university_sub_type_name.replace(/\s+/g, '-');
                    $('#tags').tagsinput('add', university_sub_type_name);
                }
           ...
           // $(".get-record").click(function() {
                    ...
                    success: function(data) {
                        if (data.status == 1) {
						   ...
						   var base_url_upload = $('#base_url_upload').val();
                            ...
                            if(data.record.university_sub_type_id){
                            $('#university_sub_type_id').val(data.record.university_sub_type_id);
                            $('#university_sub_type_id').select2({
                                placeholder: "Select University Sub Type",
                                allowClear: true
                            }).val(data.record.university_sub_type_id)
                            $('#university_sub_type_id').val(data.record.university_sub_type_id.split(',')).trigger('change');
                            }
            ...
            function resetdata() {
                ...
                $("#short_name").val("");
                $("#other_name").val("");
                $("#university_type_id").val("0");
                $("#address").val("");
                $("#landmark").val("");
                $("#university_sub_type_id").val("");
                $('#university_sub_type_id').select2({
                    placeholder: "Select University Sub Type",
                    allowClear: true
                }).val("");
