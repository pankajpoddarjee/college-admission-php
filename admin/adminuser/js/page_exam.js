...
$('body').on('click', '#save-exam-page-button', function(event) {
    ...
    $('#dvLoading').show();
    $('#save-exam-page-button').attr('disabled', 'disabled');
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status == 1) {
                ...
                resetdata();
                $('#dvLoading').hide();
                $('#save-exam-page-button').attr('disabled', '');
...
$(".status-change").click(function() {
    ...
    $.ajax({
        type: "get",
        async: false,
        url: "Save_exam_page.php?statusid=" + rid + "&status=" + status,
        dataType: "json",
        success: function(data) {
            if (data.status == 1) {
                alert(data.msg);
...
$('body').on('click', '.get-record', function(event) {
    ...
    $.ajax({
        type: "get",
        // async: false,
        url: "Save_exam_page.php?eid=" + eid,
        dataType: "json",
        success: function(data) {
            if (data.status == 1) {
