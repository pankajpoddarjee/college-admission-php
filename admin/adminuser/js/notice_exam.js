...
$(".status-change").click(function() {
    ...
    $.ajax({
        type: "get",
        async: false,
        url: "Save_notice_exam.php?statusid=" + rid + "&status=" + status,
        dataType: "json",
        success: function(data) {
            if (data.status == 1) {
                alert(data.msg);
...
$('body').on('click', '.get-record', function(event) {
    ...
    $.ajax({
        type: "get",
        // async: false,
        url: "Save_notice_exam.php?eid=" + eid,
        dataType: "json",
        success: function(data) {
            if (data.status == 1) {
...
$('body').on('click', '.get-attachment-record', function(event) {
    ...
    $('#attch_exam_id').val(cid);
    $('#attch_notice_id').val(nid);
    $('#exam_name').text(cname);
    ...
    $("#base_directory").val('../../uploads/notices/exam/' + cid);
...
function fetchOnlyDirectoryStructure(cid) {
    $.ajax({
        url: "getOnlyDirectory.php?id=" + cid + "&from=exam",
        method: 'GET',
        dataType: 'json',
        success: function(data) {
            console.log(data);
...
function fetchSubDirectoryStructure(dir) {
    var cid = $('#attch_exam_id').val();
    var dir = dir;
    $.ajax({
        url: "getSubDirectory.php?id=" + cid + "&from=exam&dir=" + dir,
        method: 'GET',
        dataType: 'json',
        success: function(data) {
            console.log(data);
...
function fetchFilenameOfDirectory(dir) {
    ...
    var exam_id = $('#attch_exam_id').val();
    var year_directory = $('#year_directory').val();

    $.ajax({
        url: "getAttachmentFile.php?notice_id=" + notice_id + "&from=exam&id=" + exam_id + "&year_directory=" + year_directory + "&dir=" + dir,
        method: 'GET',
        dataType: 'json',
        success: function(data) {
            console.log(data);
...
function fetchDirectoryStructure(cid) {
    $.ajax({
        url: "getDirectory.php?id=" + cid + "&from=exam",
        method: 'GET',
        dataType: 'json',
        success: function(data) {
...
$('body').on('click', '#save-attachment-notice-button', function(event) {
    ...
    $.ajax({
        ...
        url: "Save_attachments.php?notice_id=" + notice_id + "&from=exam&id=" + exam_id,
        data: formData,
        dataType: "json",
        success: function(data) {
            // alert(JSON.stringify(data))
            ...
            if (data.status == 1) {
                ...
                fetchDirectoryStructure(exam_id);
...
function verifyInputAttachment() {
    ...
    if ($.trim($("#year_directory").val()) == "") {
        toastr.error("Select exam Directory");
        ...
        if (year_directory) {
            if (new_directory != '' && typeof new_directory === 'string') {
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_attachments.php?newDirectory=" + new_directory + "&from=exam&id=" + exam_id + "&year_directory=" + year_directory,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
        ...
        if (year_directory) {
            if (year_directory != '' && typeof year_directory === 'string') {
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_attachments.php?newYearDirectory=" + year_directory + "&from=exam&id=" + exam_id,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            // Check if the option already exists to avoid duplication
...
function removeAttachmentFile(file_path, dir, id) {
    ...
    $.ajax({
        ...
        cache: false,
        //url: "Save_attachments.php",
        url: "Save_attachments.php?removeAttachmentFile=" + file_path + "&from=exam&dir=" + dir,
        // data: formData,
        dataType: "json",
        success: function(data) {
            // alert(JSON.stringify(data))
