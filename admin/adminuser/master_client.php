                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">Client</span></h3>
                            </div>
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-left">
                                            ...
                                            <img src="<?php echo BASE_URL_UPLOADS.'/client/'.$row['company_logo'];?>" alt="" width="100" height="50">
                                            <?php } else { ?>
