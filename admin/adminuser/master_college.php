...
//GET ALL COLLEGE
$records = [];
$strsql="select colleges.*,cities.city_name, states.state_name, districts.district_name from colleges LEFT JOIN districts ON colleges.district_id = districts.id LEFT JOIN States ON colleges.state_id=states.id LEFT JOIN cities ON cities.id = colleges.city_id order by colleges.college_name";
$stmt = $dbConn->prepare($strsql);
$stmt->execute();
$records = $stmt->fetchAll(PDO::FETCH_ASSOC);

//ADDITIONAL CONTACT MAX ID
$additional_contact_max_id = 0;
$strsql = "SELECT MAX(id) AS max_id FROM additional_contacts";
$stmt = $dbConn->prepare($strsql);
$stmt->execute();
$result = $stmt->fetch(PDO::FETCH_ASSOC);

if ($result && $result['max_id'] !== null) {
    $additional_contact_max_id = $result['max_id'];
} 
?>
<!doctype html>
<html lang="en">
    ...
    <?php include("headermenu_left.php");?>
        ...
        <?php include("headermenu_top.php");?>
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-left">
                                            <?php echo $row['college_name'];  echo (!empty($row['short_name']))?' ['.$row['short_name'].']':'';  ?> 
                                        </td>
                                        <td class="align-middle text-left"><?php echo $row['state_name'];?></td>
                                        <td class="align-middle text-left"><?php echo $row['district_name'];?></td>
                                        <td class="align-middle text-left"><?php echo $row['city_name'];?></td>
                                        ...
                                        <a class="btn btn-info btn-sm" href="<?php echo BASE_URL.'/'.$row['slug']; ?>" target="_blank" title="<?php echo $row['college_name'];?>"><i class="fa fa-external-link" aria-hidden="true"></i>
                                        </a>
                                            <?php if($row['is_active'] == 1){ ?>
            ...
            <!--MODAL START-->
            <div class="modal fade" id="add_edit_form" tabindex="-1" role="dialog" aria-labelledby="add_edit_formTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="frm1" name="frm1" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="college_name" name="college_name" placeholder="Enter College Name" autocomplete="off" maxlength="200" onload="convertToSlug();" onkeyup="convertToSlug();" onblur="convertToTags();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="short_name" name="short_name" placeholder="Enter College Short Name" autocomplete="off" maxlength="75" onblur="convertToTags();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="other_name" name="other_name" placeholder="Enter Other Name" autocomplete="off" maxlength="200" onblur="convertToTags();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select id="college_type_id" name="college_type_id" class="form-control" onchange="convertToTags();">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select id="undertaking_id" name="undertaking_id" class="form-control" onchange="convertToTags();">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="university_id">University</label>                                            
                                            <select id="university_id" multiple="multiple" name="university_id[]" class="form-control" onchange="convertToTags();">
                                            <!-- <select name="university_id[]" id="university_id" class="js-example-basic-multiple" multiple="multiple"> -->
                                                <!-- <option value="">Select</option> -->
                                                <?php if($universityRecords){ 
                                                    foreach ($universityRecords as $value) { 
                                                ?>
                                ...
                                <div class="row">    
                                	<div class="col-md-12 mb-1">
                                        <h4 class="alert alert-secondary" style="font-family:Oswald">
                                            ...
                                            <a href="javascript:void(0);" style="float:right"  data-toggle="collapse" data-target="#demo"><i class="fa-solid fa-earth-asia"></i> Add More Contact</a>
                                        </h4>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="address" name="address" placeholder="Address" autocomplete="off" maxlength="250">
                                        </div>
                                    </div>
                                ...
                                <div id="demo" class="collapse row" style="background-color:#d1ebaa">
                                    <input type="hidden" name="additional_contact_max_id" id="additional_contact_max_id" value="<?php echo $additional_contact_max_id; ?>">
                                ...
                                <a href="javascript:void(0);" id="addRow" class="btn btn-success">Add New Row</a>
                                </div>
                                ...
                                <div class="row">    
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="email">E-mail Id 1 </label>
                                            <input type="text" class="form-control" id="email" name="email" placeholder="Enter E-mail" autocomplete="off" maxlength="75">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="email2" name="email2" placeholder="Enter E-mail" autocomplete="off" maxlength="75">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter Phone Number" autocomplete="off" maxlength="75">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="website_url" name="website_url" placeholder="Enter Website URL" autocomplete="off" maxlength="75">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="website_display" name="website_display" placeholder="Enter Website Display" autocomplete="off" maxlength="75">
                                        </div>
                                    </div>
                                </div>
