<nav id="sidebar">
        ...
        <ul class="list-unstyled components">
           ...
           <?php  if( $_SESSION['usertype'] != 2){  ?>
            ...
            <li>
                <a href="#userSubMenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa-solid fa-building-columns mr-2"></i>User Master</a>
                <ul class="collapse list-unstyled" id="userSubMenu">
                    <li>
                        <a href="master_user.php"><i class="fa fa-angle-right mr-2"></i>Add / Modify User</a>
                    </li>
                </ul>
            </li>

            <li>
                <a href="#permissionMenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa-solid fa-building-columns mr-2"></i>Permission</a>
                <ul class="collapse list-unstyled" id="permissionMenu">
                    <li>
                        <a href="permission.php"><i class="fa fa-angle-right mr-2"></i>Add / Modify Permission</a>
                    </li>
                </ul>
            </li>
