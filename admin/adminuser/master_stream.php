...
$records = [];
$strsql="select streams.id,streams.stream_name,streams.short_name,streams.is_active,course_types.course_type_name from streams  join course_types on course_types.id = streams.course_type_id order by streams.stream_name";
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify Stream | Admin - <?php echo COLLEGE_NAME; ?></title>
    ...
    <?php include("headermenu_left.php");?>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">Stream</span></h3>
                            </div>
                            ...
                            <table id="master-table" class="table table-bordered order-table" style="font-family:Rubik">
                                <thead class="bg-light text-center font-weight-bold">
                                    <tr>
                                        ...
                                        <td class="align-middle">Stream </td>
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-left"> <?php echo $row['stream_name'];?> </td>
                                        <td class="align-middle text-left"> <?php echo $row['short_name'];?></td>
                                        <td class="align-middle text-left"> <?php echo  ($row['course_type_name'])?$row['course_type_name']:""?>
                                        </td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">Stream</span>
                            </h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label for="stream_name">Course Type</label>
                                            <select id="course_type_id" name="course_type_id" class="form-control">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="stream_name" name="stream_name" placeholder="Enter Stream Name" autocomplete="off" maxlength="75" tabindex="2">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label for="short_name">Stream Short Name</label>
                                            <input type="text" class="form-control" id="short_name" name="short_name" placeholder="Enter Stream Code" autocomplete="off" maxlength="75" tabindex="2">
                                        </div>
                                    </div>
        ...
        <script>
            ...
            function verifyInput() {
                if ($.trim($("#stream_name").val()) == "") {
                    toastr.error("Enter Course Name");
                    $("#stream_name").focus();
                    return false;
                } 
                if ($.trim($("#short_name").val()) == "") {
                    toastr.error("Enter Course Short Name");
                    $("#short_name").focus();
                    return false;
                }
                return true;
            ...
            $(".status-change").click(function() {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_stream.php?statusid=" + rid + "&status=" + status,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            alert(data.msg);
            ...
            $('#stream_name,#short_name').on('keypress', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 1) {
                            ...
                            $('#stream_name').val(data.record.stream_name); 
