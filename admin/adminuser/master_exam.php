...
$records = [];
$strsql="select exams.*,countries.country_name,states.state_name from exams  LEFT JOIN countries ON exams.country_id = countries.id
LEFT JOIN states ON exams.state_id = states.id order by exams.exam_name";
$stmt = $dbConn->prepare($strsql);
$stmt->execute();
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select id="country_id" name="country_id" class="form-control"  onchange="convertToTags();getState(this.value);">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select id="state_id" name="state_id" class="form-control" onchange="convertToTags();">
                                                <option value="">Select</option>                                                
                                            </select>
                                        </div>
                                    </div>
