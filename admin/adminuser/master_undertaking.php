...
$records = [];
$strsql="select id,undertaking_name,is_active from undertakings  order by undertaking_name";
...
<html lang="en">
    <head>
        ...
        <title>Add / Modify Undertaking | Admin - <?php echo COLLEGE_NAME; ?></title>
    ...
    <?php include("headermenu_left.php");?>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row m-0 border-bottom pb-2">
                        	<div class="col-md-8 text-center text-sm-left mb-3 mb-sm-0">
                            	<h3 style="font-family:Oswald"><i class="fa-solid fa-pen-to-square"></i> Add / Modify <span class="text-danger">Undertaking</span></h3>
                            </div>
                            ...
                            <table id="master-table" class="table table-bordered order-table" style="font-family:Rubik">
                                <thead class="bg-light text-center font-weight-bold">
                                    <tr>
                                        ...
                                        <td class="align-middle">Undertaking Name</td>
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-left"> <?php echo $row['undertaking_name'];?></td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addJournalModalLongTitle" style="font-family:Oswald">
                                <i class="fa-solid fa-pen-to-square"></i> Add / Edit <span class="text-danger">Undertaking</span>
                            </h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label for="undertaking_name">Undertaking Name</label>
                                            <input type="text" class="form-control" id="undertaking_name" name="undertaking_name" placeholder="Enter Undertaking Name" autocomplete="off" maxlength="75" tabindex="2">
                                        </div>
                                    </div>
        ...
        <script>
            ...
            function verifyInput() {
                if ($.trim($("#undertaking_name").val()) == "") {
                    toastr.error("Enter Undertaking Name");
                    $("#undertaking_name").focus();
                    return false;
                }
                return true;
            }
            ...
            $(".status-change").click(function() {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "Save_undertaking.php?statusid=" + rid + "&status=" + status,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            alert(data.msg);
            ...
            $('#undertaking_name').on('keypress', function(event) {
            ...
            $('body').on('click', '.get-record', function (event) {
                ...
                $.ajax({
                    type: "get",
                    //async: false,
                    url: "Save_undertaking.php?eid=" + eid,
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
                            $('#undertaking_name').val(data.record.undertaking_name);
